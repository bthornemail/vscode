...
export declare const NODE_TYPES: readonly ["file", "class", "function", "interface", "variable", "concept", "module"];
export declare const EDGE_TYPES: readonly ["imports", "extends", "implements", "calls", "references", "defines", "uses"];
export declare const AGENT_TYPES: readonly ["pocketflow", "h2gnn", "hybrid", "custom"];
export declare const COLLABORATION_ROLES: readonly ["owner", "editor", "viewer", "guest"];
export declare const LAYOUT_TYPES: readonly ["force", "hierarchical", "circular", "hyperbolic"];
